...
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_RoadPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_Attack_helicopter_conceptPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_Tron_chopper_sketchfabPlugin)
Q_IMPORT_QML_PLUGIN(HelicopterContentPlugin)
Q_IMPORT_QML_PLUGIN(HelicopterPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/HelicopterContent/App.qml";
